...
class InventoryServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        ...
        $package
            ...
            ->hasMigrations(['create_metrics_table', 'create_locations_table', 'create_inventory_stocks_table', 'create_inventory_movements_table', 'create_inventory_sku_table', 'modify_inventory_table_for_assemblies', 'create_inventory_assemblies_table'])
